<?php 
    ...
    $jumlahDataFiksi = count(query("SELECT * FROM fiksi"));
    $jumlahHalamanFiksi = ceil($jumlahDataFiksi / $jumlahDataPerHalaman);
    $halamanAktifFiksi = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
    $awalData = ($jumlahDataPerHalaman * $halamanAktifFiksi) - $jumlahDataPerHalaman;
...
<html lang="en">
  ...
  <body>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Fiction</h5>
                <div  class="close2 close" data-dismiss="modal" aria-label="Close"><span onclick="move()">&#215;</span></div>
            </div>
            <div class="modal-body">
                <div class="row">

                    <div class="col-md-6">
                        <!-- script jquery dinamic image modal
                        $("#ahbabilah").attr("src", 'img/'+gambar); -->
                        <img src="" id="ahbabilah" alt="">
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <a href="" class="mr-3 linkbabi">Download</a>
                                <a href="" class="linkbabi">Read Online</a>
                            </div>
                        </div>
    ...
    <div class="navbar kuda" id="kuda">
            <ul class="mt-3 ml-3">
                <li><a href="#" style="background-color:#343a40; color:white;">Fiction</a></li>
                <li><a href="bse2.php">BSE</a></li>
                <li><a href="nonfiksi2.php">Non-Fiction</a></li>
            ...
            <form action="" method="post" class="cari">
                <input type="text" name="keyword" placeholder="Search Here..." autocomplete="off">
    ...
    <section class="list-book" id="list-book">
            <div class="container-fluid pl-5 pr-5">
                <div class="row text-center pt-4 pb-4">
                    <div class="col-12">
                        <a href="website2.php">Home</a><span>/ Fiction </span>
                    </div>
                </div>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-fhd-2 col-md-2 mb-4 col-6">
                            <div class="card" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div class="card-body text-center">
                                    <a href="" class="card-title" data-toggle="modal" data-target="#exampleModal" id="atun"
                                    data-judul="<?= $book["judul"]; ?>" 
                                    data-penulis="<?= $book["penulis"]; ?>" 
                                    data-halaman="<?= $book["halaman"]; ?>" 
                                    data-publish="<?= $book["publish"]; ?>"
                ...
                <?php if($halamanAktifFiksi > 1) : ?>
                    <a href="?halaman=<?= $halamanAktifFiksi - 1 ?>" data-target="next" id="next"><i class="fa fa-chevron-circle-left mr-2 text-white"></i></a>
                <?php else : ?>
                    <a href=""><i class="fa fa-chevron-circle-left mr-2 text-white"></i></a>
                <?php endif; ?>
                
                <?php for($i = 1; $i <= $jumlahHalamanFiksi; $i++) : ?>
                    <?php if($i == $halamanAktifFiksi) : ?>
                ...
                <?php if($halamanAktifFiksi < $jumlahHalamanFiksi) : ?>
                    <a href="?halaman=<?= $halamanAktifFiksi +1; ?>" data-target="next" id="next"><i class="fa fa-chevron-circle-right mr-2 text-white"></i></a>
                <?php else: ?>
