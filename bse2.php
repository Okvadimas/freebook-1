<?php 
    ...
    $jumlahData = count(query("SELECT * FROM bse"));
    $jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
    $halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
    $awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;
    
    $books = query("SELECT * FROM bse LIMIT $awalData, $jumlahDataPerHalaman");
    // $books = query("SELECT * FROM fiksi");

    if (isset($_POST["cari"]) ) {
        if (strlen($_POST["keyword"]) > 0) {
            $keyword = $_POST["keyword"];
            $query = "SELECT * FROM bse WHERE 
...
<html lang="en">
  ...
  <body>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">BSE</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="mt-4">Page : <span id="page"></span></p>
                        <p class="mt-4">Kelas : <span id="kelas"></span></p>
    ...
    <div class="navbar kuda" id="kuda">
            <ul class="mt-3 ml-3">
                <li><a href="fiksi2.php">Fiction</a></li>
                <li><a href="#" style="background-color:#343a40; color:white;">BSE</a></li>
        ...
        <section class="list-book" id="list-book">
            <div class="container-fluid pl-5 pr-5">
                <div class="row text-center pt-4 pb-4">
                    <div class="col-12">
                        <a href="website2.php">Home</a><span>/ BSE </span>
                    </div>
                </div>
                <div class="row justify-content-center">
                    ...
                    <div class="col-fhd-2 col-md-2 mb-4 col-6">
                        <div class="card" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            data-gambar="<?= $book["gambar"]; ?>">
                                <?= $book["judul"]; ?></a>
                                <p class="card-text pt-1"><?= $book["kelas"]; ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
