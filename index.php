  ...
  <body>
    ...
    <div id="sidebar">
        ...
        <ul>
            ...
            <hr>
            <li class="nav-item">
                <a class="nav-link page" onclick="remove()" href="login.php">Login</a>
            </li>
            <hr>
        </ul>
    </div>
    ...
    <nav class="navbar navbar-expand-md navbar-light fixed-top pl-5 pr-5">
       ...
       <div class="collapse navbar-collapse pl-4">
            ...
            <ul class="navbar-nav ml-auto"> 
                ...
                <li class="nav-item">
                    <a class="nav-link page" href="login.php">Login</a>
                </li>
            </ul>
        </div>
    </nav>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12">
                                            <a href="login.php" class="mr-3">Download</a>
                                            <a href="login.php" class="">Read Online</a>
                                        </div>
                                    </div>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-4 d-flex align-items-center justify-content-center" data-aos="fade-up" data-aos-duration="2000"><a href="javascript:;"><img src="img/book14.jpg" alt=""></a>
                                    </div> -->
                                    <!-- <div class="col-md-4 d-flex align-items-center justify-content-center" data-aos="fade-up" data-aos-duration="3000"><a href="javascript:;" onclick="showDialog()"><img src="img/book14.jpg" alt=""></a>
                                    </div> -->
                                    <?php endforeach; ?>
                                </div>
                            </div>
            ...
            <div class="row pt-4 pb-5">
                <div class="col-lg-4" data-aos="fade-up-right" data-aos-duration="1000">
                    <div class="kartu1">
                        ...
                        <div class="back">
                            <h2><a href="nonfiksi.php">Non-Fiction</a></h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4" data-aos="fade-up-left" data-aos-duration="1000">
                    <div class="kartu3">
                        ...
                        <div class="back">
                            <h2><a href="fiksi.php">Fiction</a></h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="cardres" id="babi2">
        ...
        <h2 class="pt-4 pb-2 text-center">Book Category</h2>
            <div class="row">
                <div class="col-md-4">
                    <div class="post">
                    <a href="nonfiksi.php"><img src="img/YALTA1.jpg" alt=""></a>
                        <div class="blog-title">
                            <button class="btn"><a href="nonfiksi.php">Non-Fiction</a></button>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="post">
                    <a href="bse.php"><img src="img/YALTA2.jpg" alt=""></a>
                        <div class="blog-title">
                            <button class="btn"><a href="bse.php">BSE</a></button>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="post">
                    <a href="fiksi.php"><img src="img/YALTA3.jpg" alt=""></a>
                        <div class="blog-title">
                            <button class="btn" ><a href="fiksi.php">Fiction</a></button>
                        </div>
                    </div>
                </div>
            </div>
